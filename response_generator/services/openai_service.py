    ...
    prompt = ChatPromptTemplate.from_messages(
        [
            (
                ...
                Step 2: 
                Use the CONTEXT to formulate a suitable response to the customer query. The CONTEXT given is retrieved from a knowledge base with FAQs and relevant documents regarding MINDEF. Do not use other information outside of the CONTEXT given. Each CONTEXT will be given together with a number (database ID). Whenever you use a CONTEXT, please append the number after.
                Format:
